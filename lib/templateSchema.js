...
// Given a template's HTML, figures out which form fields to show and which
// tokens in the HTML each field replaces.
//
// Fixed vs. the original: supreme.html, canada_goose.html, and grailed.html had
// placeholder tokens in the raw HTML (PRODUCTNAME, WHOLENAME, ORDERDATE, TIMEDATE,
// PRODUCTSTYLE, PRODUCTSIZE, PRODUCTPRICE, CARTTOTAL, CARD_NUMBER, PROD_TOTAL) that
// were never mapped to a form field in the old project, so those templates would
// generate receipts with literal placeholder text still showing instead of real
// values. All three are now wired up below.
...
const TEMPLATE_SCHEMA_OVERRIDES = {
  ...
  "dyson.html": ["orderNumber", "firstName", "deliveryDate", "wholeName", "deliveryAddress", "deliveryPostcodeCity", "deliveryCountry", "billingContactName", "billingAddress1", "billingPostcodeCity", "billingCountry", "productName", "productImageUrl", "productQty", "productPrice", "shippingCost", "taxAmount", "orderTotal", "totalSavings", "serialNumber"],
...
const TEMPLATE_SCHEMA_OVERRIDES_DETAILED = {
  "amazon.html": [
    ...
    { key: "productName", label: "Product name (item 1)", type: "text", tokens: ["PRODUCT_NAME"] },
    { key: "productImageUrl", label: "Product image URL (item 1)", type: "image", tokens: ["IMAGE"] },
    { key: "productImageUrlFile", label: "Upload image file (item 1)", type: "file", tokens: [] },
    ...
    { key: "secondItemName", label: "Product name (item 2, optional)", type: "text", tokens: ["R_PRODUCT_NAM2"] },
    { key: "secondItemImage", label: "Product image URL (item 2, optional)", type: "image", tokens: ["R_IMG2"] },
    { key: "secondItemImageFile", label: "Upload image file (item 2)", type: "file", tokens: [] },
    { key: "thirdItemName", label: "Product name (item 3, optional)", type: "text", tokens: ["R_PRODUCT_NAME3"] },
    { key: "thirdItemImage", label: "Product image URL (item 3, optional)", type: "image", tokens: ["R_IMG3"] },
    { key: "thirdItemImageFile", label: "Upload image file (item 3)", type: "file", tokens: [] },
  ...
  "farfetch.html": [
    ...
    { key: "wholeName", label: "Full name (shipping block)", type: "text", tokens: ["FULLNAME"] },
  ...
  "canada_goose.html": [
    ...
    { key: "cardEnd", label: "Card ending (last 4 digits)", type: "text", tokens: ["CARD_NUMBER"] }
  ],
  "dior.html": [
    { key: "estimatedTax", label: "Taxes", type: "text", tokens: ["TAXES"] },
    { key: "wholeName", label: "Customer name", type: "text", tokens: ["WHOLE_NAME"] },
  ...
  "dyson.html": [
    { key: "orderNumber", label: "Order number", type: "text", tokens: ["ORDER_NUMBER"] },
    { key: "firstName", label: "Customer first name", type: "text", tokens: ["CUSTOMER_FIRST_NAME"] },
    { key: "deliveryDate", label: "Delivery date", type: "text", tokens: ["DELIVERY_DATE"] },
    { key: "wholeName", label: "Delivery contact name", type: "text", tokens: ["DELIVERY_NAME"] },
    { key: "deliveryAddress", label: "Delivery address (street)", type: "text", tokens: ["DELIVERY_ADDRESS1"] },
    { key: "deliveryPostcodeCity", label: "Delivery postcode & city", type: "text", tokens: ["DELIVERY_POSTCODE_CITY"] },
    { key: "deliveryCountry", label: "Delivery country", type: "text", tokens: ["DELIVERY_COUNTRY"] },
    { key: "billingContactName", label: "Billing contact name", type: "text", tokens: ["BILLING_NAME"] },
    { key: "billingAddress1", label: "Billing address (street)", type: "text", tokens: ["BILLING_ADDRESS1"] },
    { key: "billingPostcodeCity", label: "Billing postcode & city", type: "text", tokens: ["BILLING_POSTCODE_CITY"] },
    { key: "billingCountry", label: "Billing country", type: "text", tokens: ["BILLING_COUNTRY"] },
    { key: "productName", label: "Product name", type: "text", tokens: ["PRODUCT_NAME"] },
    { key: "productImageUrl", label: "Product image URL", type: "image", tokens: ["PRODUCT_IMAGE"] },
    { key: "productImageUrlFile", label: "Upload image file", type: "file", tokens: [] },
    { key: "productQty", label: "Quantity", type: "text", tokens: ["PRODUCT_QTY"] },
    { key: "productPrice", label: "Product price (with currency symbol)", type: "text", tokens: ["PRODUCT_PRICE"] },
    { key: "shippingCost", label: "Delivery fee (with currency symbol)", type: "text", tokens: ["DELIVERY_FEE"] },
    { key: "taxAmount", label: "VAT amount (with currency symbol)", type: "text", tokens: ["VAT_AMOUNT"] },
    { key: "orderTotal", label: "Order total (with currency symbol)", type: "text", tokens: ["ORDER_TOTAL"] },
    { key: "totalSavings", label: "Total savings (with currency symbol)", type: "text", tokens: ["TOTAL_SAVINGS"] },
    { key: "serialNumber", label: "Serial number", type: "text", tokens: ["SERIAL_NUMBER"] }
  ],
  "email.html": [
  ...
  "grailed.html": [
    ...
    { key: "orderTotal", label: "Order total", type: "text", tokens: ["GRAILED_ORDER_TOTAL", "PROD_TOTAL"] },
    { key: "productImageUrl", label: "Product image URL", type: "image", tokens: ["PRODUCT_IMAGE"] },
    { key: "productImageUrlFile", label: "Upload image file", type: "file", tokens: [] },
  ...
  "lv.html": [
    ...
    { key: "productName", label: "Product name", type: "text", tokens: ["PRODUCT_NAME"] },
    { key: "productPrice", label: "Product price", type: "text", tokens: ["PRODUCT_PRICE"] },
    { key: "amountDisplay", label: "Amount (symbol + whole number, e.g. $0 -> renders \"$0.00\")", type: "text", tokens: ["CURRENCY0"] },
    { key: "referenceNumber", label: "Reference number", type: "text", tokens: ["REFERENCE"] },
    { key: "productImageUrl", label: "Product image URL", type: "image", tokens: ["PRODUCT_IMAGE"] },
    { key: "productImageUrlFile", label: "Upload image file", type: "file", tokens: [] },
    ...
    { key: "supportCountryCode", label: "Support email country code (e.g. us, fr, uk)", type: "text", tokens: ["COUNTRY"] }
  ],
  "moncler.html": [
    { key: "firstName", label: "Customer first name", type: "text", tokens: ["FIRST_NAME"] },
    { key: "orderNumber", label: "Order number", type: "text", tokens: ["ORDER_NUMBER"] },
    ...
    { key: "productImageUrl", label: "Product image URL", type: "image", tokens: ["IMAGE"] },
    { key: "productImageUrlFile", label: "Upload image file", type: "file", tokens: [] },
    { key: "cardEnd", label: "Card ending (last 4 digits)", type: "text", tokens: ["CARD_END"] },
    { key: "shippingCost", label: "Shipping", type: "text", tokens: ["SHIPPING"] },
    { key: "orderTotal", label: "Total", type: "text", tokens: ["TOTAL"] },
  ...
  "nike.html": [
    ...
    { key: "productPrice", label: "Price", type: "text", tokens: ["PRICE"] },
    { key: "cardEnd", label: "Card ending (last 4 digits)", type: "text", tokens: ["CARD_END"] },
    { key: "shippingAmountDisplay", label: "Shipping & handling (symbol + whole number, e.g. $0 -> renders \"$0.00\")", type: "text", tokens: ["CURRENCY0"] },
    { key: "taxAmountDisplay", label: "Estimated tax (symbol + whole number, e.g. $10 -> renders \"$10.46\")", type: "text", tokens: ["CURRENCY10"] },
    { key: "orderTotal", label: "Total", type: "text", tokens: ["TOTAL"] },
    { key: "productImageUrl", label: "Product image URL", type: "image", tokens: ["PRODUCT_IMAGE"] },
    { key: "productImageUrlFile", label: "Upload image file", type: "file", tokens: [] },
    { key: "shippingAddress1", label: "Shipping line 1", type: "text", tokens: ["ADDRESS1"] },
  ...
  "offwhite.html": [
    { key: "firstName", label: "Customer first name", type: "text", tokens: ["NAME"] },
    { key: "orderNumber", label: "Order number", type: "text", tokens: ["ORDER_NUMBER"] },
    { key: "productName", label: "Product name", type: "text", tokens: ["PRODUCT_NAME"] },
    { key: "productPrice", label: "Product price", type: "text", tokens: ["PRODUCT_PRICE"] },
  ...
  "sephora.html": [
    ...
    { key: "shipToLine1", label: "Ship to line 1 (name)", type: "text", tokens: ["SHIP_LINE1"] },
    { key: "shipToLine2", label: "Ship to line 2 (street)", type: "text", tokens: ["SHIP_LINE2"] },
    { key: "shipToLine3", label: "Ship to line 3 (suburb, state, postcode)", type: "text", tokens: ["SHIP_LINE3"] },
    { key: "shipToLine4", label: "Ship to line 4 (country)", type: "text", tokens: ["SHIP_LINE4"] },
    { key: "productImageUrl", label: "Product image URL", type: "image", tokens: ["PRODUCT_IMAGE"] },
    { key: "productImageUrlFile", label: "Upload image file", type: "file", tokens: [] },
    { key: "itemNumber", label: "SKU / item number", type: "text", tokens: ["ITEM_NUMBER"] }
  ],
  "supreme.html": [
    { key: "wholeName", label: "Customer name", type: "text", tokens: ["WHOLENAME"] },
    { key: "date", label: "Order date", type: "text", tokens: ["ORDERDATE", "TIMEDATE"] },
    { key: "orderNumber", label: "Order number", type: "text", tokens: ["ORDERNUMBER"] },
    { key: "productName", label: "Product name", type: "text", tokens: ["PRODUCTNAME"] },
    { key: "styleId", label: "Style", type: "text", tokens: ["PRODUCTSTYLE"] },
    { key: "size", label: "Size", type: "text", tokens: ["PRODUCTSIZE"] },
    { key: "productPrice", label: "Price", type: "text", tokens: ["PRODUCTPRICE"] },
    { key: "bagSubtotal", label: "Cart total", type: "text", tokens: ["CARTTOTAL"] },
    { key: "shippingCost", label: "Shipping & handling", type: "text", tokens: ["SHIPPING"] },
    { key: "vat", label: "VAT", type: "text", tokens: ["VAT_T"] },
    { key: "orderTotal", label: "Order total", type: "text", tokens: ["ORDER_TOTAL"] },
    { key: "countryCode", label: "Country code (for faq/terms links)", type: "text", tokens: ["COUNTRY_CODE"] }
  ]
};
